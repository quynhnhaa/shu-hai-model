...
class PatchDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.phase == "validate" or self.phase == "train" or self.phase == "evaluation":
            ...
            # print("before return: input_data_shape: " + str(inp_data.shape))
            # print("label_shape: " + str(final_label.shape))
            # print(patient)
    ...
    # RuntimeError: invalid argument 0: Sizes of tensors must match except in dimension 0. Got 64 and 32 in dimension 2 at /opt/conda/conda-bld/pytorch_1549636813070/work/aten/src/TH/generic/THTensorMoreMath.cpp:1307
    def __len__(self):
